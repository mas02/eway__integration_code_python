...
gstr_urls = {
    ...
    'auth_url' : host + '/ewaybillapi/v1.03/authenticate',
    'eway_url' :host + '/ewaybillapi/v1.03/ewayapi',
    'get_eway' : host + '/ewaybillapi/v1.03/ewayapi/GetEwayBill',
